		...
		game_loop:
			...
			loop_over_bullet:
				...
				inner_loop_over_enemies:
					...
					; set cordinates of enemy
					mov ah, enemy_x[si]
					mov current_enemy_x, ah
					mov ah, enemy_y[si]
					mov current_enemy_y, ah
				
					; check if enemy and bullet have same position
				...
				; get si from variable
				mov si, [current_bullet_ptr]
			jmp loop_over_bullet
			exit_loop_over_bullet:
				
			;if cycle counter is equal to 5 or 10
			...
			move_down_enemy:
				...
				loop_over_enemies:
					...
					; increment y (move down the screen)
					inc dl
					mov enemy_y[si], dl
			...
			; check if cycle_counter is equal to 20	
			cmp cycle_counter, 20	
			jl dont_spawn	
				
				; get random value
				mov ah, 00h; interupts to get system time
				int 1ah
				...
				loop_over_enemies_2:
					...
					; if si is greater or equal enemy array_size
					cmp si, enemy_max
			...
			render:
				...
				draw_y:
					...
					draw_x:
						...
						; if x is equal or greater then 25
						; quit the loop
						; add start drawing next iine
						cmp cursor_x, 25
						jl dont_exit_draw_x
						jmp exit_draw_x
						dont_exit_draw_x:
							...
							render_2:
								...
								loop_over_enemies_render:
									...
									; if si is equal or greater enemy array
									cmp si, enemy_max
									jge exit_loop_over_enemies_render
				
									; check if current array field isn't empty
									mov ah, enemy_y[si]
									cmp ah, 0
